...
public class PhoneBook {
	...
	Address addressPerson1= new Address("114", "Market St", "St Louis", "MO", "63403", "6366435698", "doe@test.com");
	Address addressPerson2= new Address("324", "Main St", "St Charles", "MO", "63303", "8475390126", "edoe@test.com");
	Address addressPerson3= new Address("574", "Pole Ave", "St Peters", "MO", "63333", "5628592375", "westdoe@test.com");
    ...
    while(true)
    {
        ...
        switch(opt)
        {
            case 1: // add new record
    		    ...
    		    Person p = new Person(firstName,lastName,new Address(streetNum,streetNam,city,state,zip,phone,eMail));
            ...
            case 4:  //Search by Last name
                ...
                for (int i=0; i<persons.length; i++) {
            		...
            		if(persons[i].getLastName().equals(case4)) {
            			System.out.println(persons[i].getFirstName()+" "+persons[i].getLastName()+" "+persons[i].getAddress());
            			test4=false;
            		}
                  }
            	}
